...
export class CntFlexyViewAdamPromoIntro implements ComponentInterface {
  ...
  render() {
    return (
      <header class="main-header" style={{backgroundImage: `url(${this.payload.img})`}} >
        <div class="container">
          <div class="row personal-profile">
            <div class="col-md-4 personal-profile-avatar-wrapper">
              <div class="personal-profile-avatar" style={{backgroundImage: `url(${this.payload.img})`}}>
              </div>
            </div>
            <div class="col-md-8">
              ...
              <div class="personal-profile-contacts">
                <dl class="contact-list">
                  ...
                  <dt>Телефон:</dt>
                  <dd><a href={'tel:'+this.payload.phone+''}>{this.payload.phone}</a></dd>
                  <dt>Почта:</dt>
                  <dd><a href={'mailto:'+this.payload.mail+''}>{this.payload.mail}</a></dd>
                  <dt>Адрес:</dt>
